...
- [ ] The deployment step has resolved every `{{LINE:…}}` in `FEEDBACK.md` and `submission/*.md` to GitHub line links. Check with `grep -rn '{{LINE:' FEEDBACK.md submission/`, which should print nothing.

...
| Unichain Sepolia, chain 1301 | Deployment pending deployer funding; no verified addresses claimed |
| Ethereum fork | Intent bridge not shipped; no Ethereum manifest |

FUND ME: `0x094d5923EFC18a97E395b28a97BC4D5bD027dC0c` (Unichain Sepolia)
...
`make testnet` targets Unichain Sepolia with mock issuers and verification. Fund the address above before running it. No tokenized-stock issuer is represented as having endorsed this project.

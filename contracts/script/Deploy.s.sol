...
contract Deploy is Script {
 ...
 function _key(address a,address b,uint24 fee,address hook) internal pure returns(PoolKey memory){return PoolKey(Currency.wrap(a<b?a:b),Currency.wrap(a<b?b:a),fee,fee==500?int24(1):int24(60),IHooks(hook));}

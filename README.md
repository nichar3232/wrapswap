...
- The demo relay signs with a funded testnet key so visitors without a wallet can act. It has no size cap and no rate limit of its own; the web server allows 600 requests per minute per IP.
